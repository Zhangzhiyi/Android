...
public class CustomTextView extends TextView{
	...
	*/
	...
	private int calculateScrollingLen() {
		...
		Log.i("TextHeight", String.valueOf(rect.height()));
		float textSize = tp.getTextSize();
		Log.i("TextSize", String.valueOf(textSize));
		float textLength = tp.measureText(strTxt);
		Log.i("TextLenght1", String.valueOf(textLength));
	...
	　*/
	/**在View的绘制过程中会不断地调用此函数来确定位置的**/
	public void computeScroll() {
		/**按F3看TextView的computeScroll()方法，TextView已经重写了,所以TextView有自己的Scroller**/
		super.computeScroll();
		Log.i("mSlr.getCurrX()", String.valueOf(mSlr.getCurrX()));
