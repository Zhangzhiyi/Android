...
public class PullRefreshLayout extends ViewGroup {
	...
	public PullRefreshLayout(Context context, AttributeSet attrs) {
		...
		mHeaderLayout = (RelativeLayout) LayoutInflater.from(getContext()).inflate(R.layout.pull_to_refresh, null);
		mArrowView = (ImageView) mHeaderLayout.findViewById(R.id.arrow);
		mLoadingView = (ImageView) mHeaderLayout.findViewById(R.id.refresh_dropdown_loading);
		mDescriptionText = (TextView) mHeaderLayout.findViewById(R.id.description);
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		mHeaderLayout.measure(widthMeasureSpec, MeasureSpec.makeMeasureSpec(headerHeight, MeasureSpec.EXACTLY));
		...
		for (int index = 0; index < getChildCount(); index++) {
			if (getChildAt(index) == mHeaderLayout) {
	...
	private void animateOffsetToStartPosition() {
		...
		mHeaderLayout.startAnimation(mAnimateToStartPosition);
	}
	...
	private void animateOffsetToCorrectPosition() {
		...
		mHeaderLayout.clearAnimation();
		mHeaderLayout.startAnimation(mAnimateToCorrectPosition);
	}
	...
	private void setTargetOffsetTop(int offset, boolean requiresUpdate) {
		...
		mHeaderLayout.bringToFront();
		mHeaderLayout.offsetTopAndBottom(offset);
		mCurrentOffsetTop = mTarget.getTop();
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		// mCurrentOffsetTop);
		mHeaderLayout.layout(left, -headerHeight + mOriginalOffsetTop + mCurrentOffsetTop, left + width - right, mOriginalOffsetTop + mCurrentOffsetTop);
	}
	...
	public void setProgressViewOffset(boolean scale, int start) {
		mHeaderLayout.setVisibility(View.GONE);
	...
	public void startAnimaltion(ImageView mLoadingAnimation) {
		...
		animation.setFillAfter(true);
		mLoadingAnimation.startAnimation(animation);
	}
}
