 ...
 * Original file: D:\\android-sdk-windows-1.5_r3\\代码\\Android-OPhone-src\\Android-OPhone开发完全讲义\\src\\ch08\\ch08_aidl\\src\\net\\blogjava\\mobile\\aidl\\IMyService.aidl
 */
...
case TRANSACTION_changeValue:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
this.changeValue(_arg0);
reply.writeNoException();
return true;
}
}
...
public void changeValue(int value) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_changeValue, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_changeValue = (IBinder.FIRST_CALL_TRANSACTION + 1);
}
public java.lang.String getValue() throws android.os.RemoteException;
public void changeValue(int value) throws android.os.RemoteException;
}
