...
public final class Diary {
    ...
    public static final class DiaryColumns implements BaseColumns {
        ...
        /**用系统的searche查询自己数据库一定要有以下的字段吗？**/
        //public static final String TITLE = SearchManager.SUGGEST_COLUMN_TEXT_1;

        //public static final String BODY = SearchManager.SUGGEST_COLUMN_TEXT_2;
