...
public class TestViewCoordinates extends Activity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
			case R.id.button1:
				Log.i("Button1", "left:" + mButton1.getLeft() + "," + "top:" + mButton1.getTop());
				Log.i("Button1", "" + mButton1.getWidth() + "," + mButton1.getHeight());
		        ...
		        Log.i("DisplayFrame", rect.toString() + " statusHeight:" + rect.top + " titleHeight:" + titleHeight);
			...
			case R.id.button2:
				...
				mButton2.getGlobalVisibleRect(rect, point);
				Log.i("getGlobalVisibleRect Point", "rect:" + rect.toString() + " point:" + point.toString());
