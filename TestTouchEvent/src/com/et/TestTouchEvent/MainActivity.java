...
public class MainActivity extends Activity {
	public static final String TAG_LinearLayout = "MainActivity$LinearLayout";
	public static final String TAG_TextView = "MainActivity$MyTextView";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		myTextView.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				case MotionEvent.ACTION_MOVE:
					Log.i(TAG_TextView + " onTouch", "MotionEvent.ACTION_MOVE");
					/**
					...
					// //跳过了linearLayout1的onInterceptTouchEvent的move事件和up事件
					break;
				case MotionEvent.ACTION_UP:
					Log.i(TAG_TextView + " onTouch", "MotionEvent.ACTION_UP");
					/**
				...
				case MotionEvent.ACTION_CANCEL:
					Log.i(TAG_TextView + " onTouch", "MotionEvent.ACTION_CANCEL");
					break;
				}
				return false;
			}
		...
		/***
		 * 如果ViewGroup里面的子控件能够处理触摸事件，是不会运行ViewGroup的OnTouchListener的
		 */
		linearLayout1.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				switch (action) {
				case MotionEvent.ACTION_DOWN:
					Log.i(TAG_LinearLayout + " onTouch", "MotionEvent.ACTION_DOWN");
					break;
				case MotionEvent.ACTION_MOVE:
					Log.i(TAG_LinearLayout + " onTouch", "MotionEvent.ACTION_MOVE");
					break;
				case MotionEvent.ACTION_UP:
					Log.i(TAG_LinearLayout + " onTouch", "MotionEvent.ACTION_UP");
					break;
				case MotionEvent.ACTION_CANCEL:
					Log.i(TAG_LinearLayout + " onTouch", "MotionEvent.ACTION_CANCEL");
					break;
				}
				return false;
			}
